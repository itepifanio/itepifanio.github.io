...
![Parte de um Jupyter notebook que inclui uma seção com texto em formato markdown e código python](jupyter-markdown-and-code.png)
...
![Capa do vídeo "Eu gosto de Jupyter notebooks" que, além do título garrafal, mostra ao fundo o Lula Molusco em cima de um palco, se esquivando de tomates sendo jogados pela plateia](i-like-notebooks.jpg)
